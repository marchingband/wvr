...
* **D7 D8 D9** and **D10** are input only pins (digitalWrite() will have no effect). These pins do not have internal pullups available. This is a feature missing from the ESP32, so design your hardware with external pullups when needed.
