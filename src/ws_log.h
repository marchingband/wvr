...
int w_log_printf(const char *fmt, ...);

#if ARDUHAL_LOG_LEVEL >= ARDUHAL_LOG_LEVEL_VERBOSE
#define wlog_v(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(V, format), ##__VA_ARGS__)
...
#define wlog_d(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(D, format), ##__VA_ARGS__)
...
#define wlog_i(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(I, format), ##__VA_ARGS__)
...
#define wlog_w(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(W, format), ##__VA_ARGS__)
...
#define wlog_e(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(E, format), ##__VA_ARGS__)
...
#define wlog_n(format, ...) w_log_printf(ARDUHAL_LOG_FORMAT(E, format), ##__VA_ARGS__)
